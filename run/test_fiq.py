...
from dataloader.dataset import targetpad_transform, FashionIQDataset
...
def compute_fiq_val_metrics(
    ...
    print("R@10:", recall_at10, "   R@50:", recall_at50)
...
if __name__ == '__main__':
    ...
    for _, dress_type in enumerate(['dress', 'toptee', 'shirt']):
        ...
        index_list = extract_index_features(classic_val_dataset, clip_model, args.patch_num, device, args.feature_dim)
