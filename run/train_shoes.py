...
def train_shoes(num_epochs, lr, batch_size, patch_num, clip_bs, clip_model_name, **kwargs):
            ...
            if idx == len(train_loader) - 1 or idx % kwargs["print_frequency"] == 0:
                ...
                if idx == len(train_loader) - 1:
                    ...
                    if r_average > best_r_average:
                        ...
                        if local_rank == 0:
                            print("Mean Now: {:.5f} Best Mean Before: {:.5f} {}".format(r_average, best_r_average, "-" * 20))
